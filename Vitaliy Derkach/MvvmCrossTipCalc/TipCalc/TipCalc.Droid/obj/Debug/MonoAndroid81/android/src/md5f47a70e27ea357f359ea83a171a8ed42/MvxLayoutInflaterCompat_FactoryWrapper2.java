...
public class MvxLayoutInflaterCompat_FactoryWrapper2
	extends md5f47a70e27ea357f359ea83a171a8ed42.MvxLayoutInflaterCompat_FactoryWrapper
	implements
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MvvmCross.Platforms.Android.Binding.Binders.MvxLayoutInflaterCompat+FactoryWrapper2, MvvmCross", MvxLayoutInflaterCompat_FactoryWrapper2.class, __md_methods);
	}
	...
	public MvxLayoutInflaterCompat_FactoryWrapper2 ()
	{
		...
		if (getClass () == MvxLayoutInflaterCompat_FactoryWrapper2.class)
			mono.android.TypeManager.Activate ("MvvmCross.Platforms.Android.Binding.Binders.MvxLayoutInflaterCompat+FactoryWrapper2, MvvmCross", "", this, new java.lang.Object[] {  });
	}
