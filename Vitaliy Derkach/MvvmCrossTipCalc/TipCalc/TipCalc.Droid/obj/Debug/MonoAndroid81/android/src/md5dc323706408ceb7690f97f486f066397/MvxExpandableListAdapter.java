...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MvvmCross.Platforms.Android.Binding.Views.MvxExpandableListAdapter, MvvmCross", MvxExpandableListAdapter.class, __md_methods);
	}
	...
	public MvxExpandableListAdapter ()
	{
		...
		if (getClass () == MvxExpandableListAdapter.class)
			mono.android.TypeManager.Activate ("MvvmCross.Platforms.Android.Binding.Views.MvxExpandableListAdapter, MvvmCross", "", this, new java.lang.Object[] {  });
	}
	...
	public MvxExpandableListAdapter (android.content.Context p0)
	{
		super ();
		if (getClass () == MvxExpandableListAdapter.class)
			mono.android.TypeManager.Activate ("MvvmCross.Platforms.Android.Binding.Views.MvxExpandableListAdapter, MvvmCross", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
	}
